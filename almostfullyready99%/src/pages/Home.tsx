          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 px-4">
            {admin ? (
              <a href="/team">
                <div className={styles.container}>
                  ...
                  <h3 className={styles.text}>{t("Team")}</h3>
                </div>
              </a>
            ) : null}
            <a href="/schedule" className={!admin ? "md:col-span-2" : ""}>
              <div className={styles.container}>
                ...
                <h3 className={styles.text}>{t("Schedule")}</h3>
              </div>
            </a>
            <a href="/clients">
              <div className={styles.container}>
                <BsPersonFill size={iconSize} />
                <h3 className={styles.text}>{t("Clients")}</h3>
              </div>
            </a>
            <div className={styles.container} onClick={logOut}>
              <BiLogOut size={iconSize} />
              <h3 className={styles.text}>{t("Logout")}</h3>
            </div>
          </div>
        </div>
      </div>
